...
const StyledButton = styled(Button)(({ theme }) => ({
  background: 'linear-gradient(45deg, #a8e6cf 30%, #dcedc1 90%)',  // Mintgrön gradient bakgrund
  ...
  top: '90px',  // Placering från toppen
  ...
  fontWeight: 'bold',  // Tydligare text
  ...
  '&:hover': {
    background: 'linear-gradient(45deg, #dcedc1 30%, #a8e6cf 90%)',  // Omvänd gradient vid hover
